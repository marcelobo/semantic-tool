...
public class DirectIndividualbyPropertySimilarity extends PenaltyAllowedFunction implements ISimilarityFunction, StringBasedFunction{
   ...
   public DirectIndividualbyPropertySimilarity(IEditDistance strategyEditDistance, ICombination strategyCalculation){
    ...
    // Caso sejam propriedades então verifica TODOS os valores da propriedade
     private float execute(OntProperty p1, OntProperty p2) {

         int max=0,min=0;
         //Testar se o código abaixo está OK. Principalmente com o listProperties(p1 e p2)
         //Caso o código esteja ok, ainda é necessário fazer o cálculo da similaridade
            // Ou seja, inserir os pares no array, depois a combinação  e depois o valor da similaridade
