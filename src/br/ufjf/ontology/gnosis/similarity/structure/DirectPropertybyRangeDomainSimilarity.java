...
import br.ufjf.ontology.gnosis.similarity.TabelaSimilaridade;
...
public class DirectPropertybyRangeDomainSimilarity extends PenaltyAllowedFunction implements ISimilarityFunction, StringBasedFunction{
    ...
    //Se forem propriedades, pegar a similaridade do range e do domain e tirar a média.
    ...
    private float verificaOcorrencia(OntResource or1, OntResource or2) {
        ...
        // tenta verificar se a similaridade entre os dois conceitos de range já foi calculada
        else {
