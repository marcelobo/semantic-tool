...
/**
 * Essa classe é utilizada para mapear entidades (conceitos, relacoes, individuos, etc) já recuperados da ontologia
 * A única utilidade da classe é melhorar o desempenho do sistema pois as funções de listar entidades do JENA são muito custosas
 *
 * @author jairo
 */
public class OntologyCache {
    ...
    /***
     * Esse método foi projetado somente retornar (e, se precisar, adicionar no mapa) todas as propriedades do conceito
     * @param ont
     * @return
     */
    ...
    /***
     * Esse método foi projetado somente retornar (e, se precisar, adicionar no mapa) todas as instancias do conceito
     * @param ont
     * @return
     */
    ...
    /***
     * Esse método foi projetado somente retornar (e, se precisar, adicionar no mapa) todas as subclasses do conceito
     * @param ont
     * @return
     */
    ...
    /***
     * Esse método foi projetado somente retornar (e, se precisar, adicionar no mapa) todas as superclasses do conceito
     * @param ont
     * @return
     */
    ...
    /***
     * Esse método foi projetado somente retornar (e, se precisar, adicionar no mapa) todas as propriedades de um dado individuo
     * @param ont
     * @return
     */
    ...
    /***
     * Esse método foi projetado somente retornar (e, se precisar, adicionar no mapa) todas as propriedades indiretas de uma dada classe
     * @param ont
     * @return
     */
    ...
    /***
     * Esse método foi projetado somente retornar (e, se precisar, adicionar no mapa) todas as instancias 
