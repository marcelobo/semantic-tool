...
import br.ufjf.ontology.gnosis.similarity.combination.DeepCombination;
...
import br.ufjf.ontology.gnosis.similarity.editdistance.DamerauLevenshteinEditDistance;
...
public class DirectIndividualSimilarity extends PenaltyAllowedFunction implements ISimilarityFunction, StringBasedFunction{
   ...
   public DirectIndividualSimilarity(IEditDistance strategyEditDistance, ICombination strategyCalculation){
    ...
    // Caso sejam propriedades, não verifica todos os valores das propriedades
     ...
     private float execute(OntClass c1, OntClass c2)
    {
        ...
        // Se o conceito não possui individuos com o mesmo nome, então checa se o valor das propriedades dos individuos desse conceito são iguais
        if (similarity==0)
