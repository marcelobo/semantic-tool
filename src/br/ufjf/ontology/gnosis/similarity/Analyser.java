...
import br.ufjf.ontology.gnosis.parser.XMLReader;
...
public class Analyser {
    ...
    public TabelaSimilaridade process() throws Exception {
        ...
        // Eu sei, o código abaixo não está bem modelado, mas estou no final do doutorado e é um bacalhau para ganhar tempo
    ...
    // Não estamos interessados em alinhamentos entre propriedades e conceitos.
    // Assim, filtramos a entrada na tabela para evitar que propriedades sejam analisadas com conceitos.
    // Essa decisão também evita com que o tamanho da tabela cresça consideravelmente.
