 ...
 *  CLASSE: Cromossomo.
 *  FUN√á√ÉO: Realiza opera√ß√µes com cromossomos.
 * 
 */
...
public class Cromossomo implements Serializable, Comparable<Cromossomo> {
    ...
    /**
     * Cria um cromossomo com fitness aleat√≥rio
     * @param numeroGenes
     */
    public Cromossomo(int numeroGenes, ArrayPesosGranulares pesos, List<String> niveis) {
        ...
        // Primeiro sortear um gene e, apÛs, sortear um valor para o gene
        ...
        // Guarda a soma dos genes irm„os (no mesmo nÌvel da ·rvore)
        ...
        //TODO se esse cÛdigo est· correto, significa que n„o pode ter cromossomo com fitness >1. 
        //PorÈm isso acontece com vencedores das primeiras geraÁıes... pq?
    ...
    // Necess√°rio limpar os resultados pois eles podem mudar se um cromossomo sofrer muta√ß√£o.
