...
public class Equacao {
    ...
    /*
     * Faz percurso pos-ordem e vai somando para saber o numero de funções
     */
    ...
    /*
     * Passa um cromossomo e ele vai preenchendo a função colocando os genes no lugar dos
     * pesos num percurso pos-ordem
     */
    public void setPesos(Cromossomo cro){
        ArrayList<Gene> genes = (ArrayList<Gene>) cro.genes.clone();

        //Como a primeira não tem que passar gene, passaremos apenas para os filhaos dela
