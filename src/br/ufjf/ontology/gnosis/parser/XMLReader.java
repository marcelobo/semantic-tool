package br.ufjf.ontology.gnosis.parser;
...
import br.ufjf.ontology.gnosis.similarity.common.WeightVO;
import br.ufjf.ontology.gnosis.similarity.editdistance.IEditDistance;
import br.ufjf.ontology.gnosis.similarity.exception.WeightException;
import br.ufjf.ontology.gnosis.similarity.structure.OntologyCache;
...
public class XMLReader  {
    ...
    private Collection<FunctionWeightVO> createFunctions(Element containerPrincipal) throws ClassNotFoundException, NoSuchMethodException, InstantiationException, WeightException, IllegalArgumentException, InvocationTargetException, IllegalAccessException, DataConversionException {
        ...
        while (i.hasNext()) {
            ...
            //Verifica se o ele √© uma function ou um container
            if (element.getName().equals(XMLElements.function_XML)){
                ...
                //Recupera o valor da penalidade que ser√° passada para o metodo
                ...
                if (elementPenalidade != null) {
                    ...
                    //Recupera as classes que ser√£o passadas para o metodo
                ...
                //Seta o functionWeightVo com a Fun√ß√£o e o Peso
    ...
    private Collection<List<OntResource>> createOntologies(Element root) {
        ...
        //Listas para guardar as classes que ser√£o verificadas
        ...
        //Definir se as ontologias associadas devem ou nao ser carregadas, no caso √© n√£o.
        ...
        //Recupera as classes que vamos verificar a semelhan√ßa.
        ...
        // Verifica se usar· os pre-alinhamentos
    ...
    private void preencheLista(OntModel model, List conceitos, List<OntResource> elementosOnto) {
        ...
        // Caso o usu·rio n„o especificou classes da ontologia
        // Neste caso, ser„o acrescentadas na lista todas as classes e propriedades da ontologia
        if (conceitos.isEmpty())
            preencheLista(c1, model, elementosOnto);

        // Caso o usu·rio especificou classes da ontologia
        // TODO permitir que o usu·rio possa especificar Recursos, ao invÈs de classes, o que significa que poderia colocar tambÈm propriedades no XML.
